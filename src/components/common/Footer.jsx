        ...
        <div className="container">
          <div className="row mb-5">
            <div className="col-md-3 pb-3">
              ...
              <p className="pt-3 pe-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
            </div>
            <div className="col-md-3 pb-3">
          ...
          <div className="row">
            <div className="col-md-12">
              <p className="text-center pt-5">&copy; 2026 All Rights Reserved</p>
            </div>
          </div>
        </div>
      </footer>
